...
putenv('ORACLE_HOME=/u01/app/oracle/product/11.2.0/client_1');
putenv('NLS_LANG=japanese_japan.UTF8');

$CFG->dbtype    = 'oci';      // 'pgsql', 'mariadb', 'mysqli', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'rdltdb';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'zgdb99';     // database name, eg moodle
$CFG->dbuser    = 'moodledev';   // your database username
...
$CFG->dboptions = array(
    ...
    'dbport'    => '1522',          // the TCP port number to use when connecting
...
// $CFG->wwwroot   = 'http://zukenrd2:6060';
 $CFG->wwwroot   = 'https://rdnet.zuken.com/moodle';
